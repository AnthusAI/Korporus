...
function getStyles(darkMode: boolean) {
  return {
    ...
    a: { color: darkMode ? "#93c5fd" : "#2563eb", textDecoration: "none" } as const,
    code: {
    ...
    hr: { border: "none", borderTop: `1px solid ${darkMode ? "#334155" : "#e2e8f0"}`, margin: "24px 0" } as const,
    anchorHint: darkMode ? "#64748b" : "#94a3b8",
  };
}
...
function HeadingWithAnchor({
  ...
  return createElement(
    ...
    {
      id,
      style: { ...headingStyle, position: "relative", cursor: id ? "pointer" : "default" },
...
export function MarkdownRenderer({ markdown }: { markdown: string }) {
  ...
  const components: Components = {
    h1: ({ children, ...props }) => (
      <HeadingWithAnchor level={1} id={props.id} headingStyle={styles.h1} anchorHint={styles.anchorHint}>
        {children}
      </HeadingWithAnchor>
    ),
    h2: ({ children, ...props }) => (
      <HeadingWithAnchor level={2} id={props.id} headingStyle={styles.h2} anchorHint={styles.anchorHint}>
        {children}
      </HeadingWithAnchor>
    ),
    h3: ({ children, ...props }) => (
      <HeadingWithAnchor level={3} id={props.id} headingStyle={styles.h3} anchorHint={styles.anchorHint}>
        {children}
      </HeadingWithAnchor>
    ),
    h4: ({ children, ...props }) => (
      <HeadingWithAnchor level={4} id={props.id} headingStyle={styles.h4} anchorHint={styles.anchorHint}>
        {children}
      </HeadingWithAnchor>
    ),
